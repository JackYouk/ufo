...
let maxVelocity = 0.16;  // Increased max velocity for faster yaw and pitch
let jawVelocity = 0;
let pitchVelocity = 0;
let planeSpeed = 0.024;  // Increased base speed for normal movement
export let turbo = 0;
...
export function updatePlaneAxis(x, y, z, planePosition, camera) {
  ...
  let turboSpeed = easeOutQuad(turbo) * 0.08;
